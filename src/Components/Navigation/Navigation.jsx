...
export default function Navigation({
  ...
  if (
    location.pathname === "/colorrecognition" ||
    location.pathname === "/facerecognition"
  ) {
    return (
      <nav
        style={{
    ...
    return (
      <nav style={{ display: "flex", justifyContent: "flex-end" }}>
        <NavLink to="/" className="f3 pa2 pointer white ">
          Sign In
        </NavLink>
        <NavLink to="/register" className="f3 pa2 pointer white">
          Register{" "}
        </NavLink>
      </nav>
    );

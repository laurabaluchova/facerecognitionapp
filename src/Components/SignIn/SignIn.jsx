        ...
        <div className="measure ">
          <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
            ...
            <div className="mv3">
              ...
              />
              {passwordHasError && (
                <p className="purple">Field cannot be empty</p>
              )}
            </div>
          </fieldset>
          <div className="">
            <input
              ...
              className="b ph3 pv2 input-reset ba b--white bw2 bg-transparent grow pointer f6 dib white hover-bg-purple"
              type="submit"
              value={ctx.isLoading ? "Loading..." : "Sign in"}
              style={{ cursor: ctx.cursor }}
            />
          </div>
          <div className="lh-copy mt3">
            <Link
              ...
              className="f6 link hover-purple white db pointer mb3"
            >
              Register
            </Link>
          </div>
